...
export class OnboardingService {
    ...
    getFloorPlanDetailsByFloorId(floorId) {
        let url = "http://10.8.0.19:9988/webconversion/entityInfo/getByExternalFloorId?externalFloorId="+floorId;
    ...
    uploadFile(file) {
        ...
        //let url = "http://10.8.0.193:9988/webconversion/generateTilesUpdated";
    ...
    uploadFloorPlanFile(file) {
        //let url = `${this.upload_Url}webconversion/generateTilesUpdated`;
        let url = "http://10.8.0.19:9988/webconversion/upload";
        const formData: FormData = new FormData();
        formData.append("file", file, file.name);
    ...
    getAllAttributes() {
        ...
        let url = `http://10.8.0.191:9988/webconversion/entityInfo/getByExternalFloorId?externalFloorId=acc1`;
        //let url = "http://10.8.0.193:9988/webconversion/generateTilesUpdated";
